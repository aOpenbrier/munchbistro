const menu = {
    "menumain": [
        {
            "section title": "CHEF'S FAVORITES",
            "section items": [
            {
            "price": 13,
            "name": "BBQ Pork Ribs",
        ...
        {
            "price": 13,
            "name": "Munch On The Beach",
            "description": "Thinly sliced beef sauteed with red wine, fresh jalapeno, white onion, green onion, mushroom and garlic."
        },
        {
            "price": 12,
            "name": "Cashew Nut",
        ...
        },
        {
            "price": 12,
            "name": "Spicy Eggplant",
            "description": "Chicken white meat sauteed with eggplant, white onion, jalapeno and sweet basil."
        },
        {
            "price": 13,
            "name": "Broccoli Beef",
            "description": "Thinly sliced beef sauteed with red wine, broccoli, carrot and garlic."
        },
        ],
        },
        {
        ...
        {
            "price": 11,
            "name": "Lemongrass Striper Fish",
            "description": "Steamed striper fish seasoned with fresh garlic, mint leaves, lemon grass and Thai chili lime sauce."
        },
        {
            "price": 10,
            "name": "Calamari",
        ...
        },
        {
            ...
            "description": "Topped with traditional Thai chili-lime dressing with red and green onion, crispy shallot and cilantro."
        },
        {
            "price": 20,
            "name": "Waterfall Beef",
        ...
        },
        {
            ...
            },
            {
                "extras": `substitution:<br>
                    ...
                    chicken white meat +&nbsp;$1 | beef&nbsp;+&nbsp;$2 | shrimp&nbsp;+&nbsp;$3<br>
                    <br>
                    side order: <br>
                    white rice&nbsp;$1, brown rice&nbsp;$2 <br>
                    <br>
            ...
            },
            {
                "price": 13,
                "name": "Dumpling Soup",
                "description": "Thai classic clear soup with chicken - veggies dumplings, shrimp, chicken and napa cabbage in lightly seasoned broth, topped with green onion and cilantro."
            },
            ],
        },
        {
        ...
        },
        {
            ...
            },
            {
                "price": 11,
                "name": "Panang Curry",
                "description": "Cooked with creamy coconut milk, red bell pepper, Thai eggplant seasoned with dried chili, coriander root and cumin."
            },
            ],
        },
        {
            ...
            },
            {
                ...
                "price": 11,
                "name": "Chow Mein",
                "description": "Stir fried yakisoba noodles, celery, carrot, onion, green onion, cabbage and beansprouts."
            },
            ],
        },
        {
    ...
    "menuspecials": [
        {
            ...
            "section items": [
                ...
                },
                {
                    "price": 8.99,
                    "name": "Pad Thai",
                    "description": "Stir fried rice noodles with red onion egg, green onion, bean sprouts, and crushed peanut.",
                },
                {
                    "price": 8.99,
                    "name": "Sweet 'N Sour",
                    "description": "Stir fried with pineapple, cucumber, onion, tomato, celery and carrot.",
                },
                {
                    "price": 8.99,
                    "name": "Pad See Ew",
                    "description": "Stir fried flat rice noodles with egg, broccoli, seasoned with sweet black soy sauce.",
                },
                {
                    "price": 8.99,
                    "name": "Spicy Basil",
                    "description": "Stir fried with chili, onion, garlic, green bean, red bell pepper, basil.",
                },
                {
                    "price": 8.99,
                    "name": "Cashew Nut",
                    "description": "Stir fried with cashew nuts, carrot, onion, green onion, celery and Thai sweet-chili paste.",
                },
                {
                    "price": 8.99,
                    "name": "Yellow Curry",
                    "description": "In creamy coconut milk, carrot and potato.",
                },
                {
                    "price": 8.99,
                    "name": "Orange Chicken",
            ...
            "section details": "Available all day. Everyday.",
        },
    ],
    "menuveg": [
        {
        ...
        {
            "section title": "VEGAN ENTREE",
            "section items": [
                {
                    "price": 13.50,
                    "name": "Munch On The Beach",
                    "description": "Fried tofu or soft tofu sautéed with red wine, fresh jalapeño, onion, green onion, mushroom and garlic.",
                },
                {
                    "price": 13.50,
                    "name": "Spicy Basil",
                    "description": "Fried tofu or soft tofu sautéed with sake, chili, onion, green bean, garlic, green bell pepper and basil leaves.",
                },
                {
                    "price": 13.50,
                    "name": "Cashew Nut",
                    "description": "Fried tofu or soft tofu sautéed with cashew nuts, carrot, onion, green onion, celery and sweet-chili paste.",
                },
                {
                    "price": 13.50,
                    "name": "Broccoli",
                    "description": "Fried Tofu or soft tofu with red wine, broccoli, carrot, hoisin sauce",
                },
                {
                    "price": 13.50,
                    "name": "Spicy Eggplant",
                    "description": "Fried tofu or soft tofu with eggplant, white onion, jalapeño, basil.",
                },
            ],
        },
        {
            "section title": "VEGAN FRIED NOODLES AND RICE",
            "section items": [
                {
                    "price": 13.50,
                    "name": "Pad Thai",
                    "description": "Stir fried with Thai rice noodles with red onion, green onion and bean sprouts served with crushed peanut.",
                    "options": "(Options : Fried Tofu, Soft Tofu or Mixed Veggies)",
                },
                {
                    "price": 13.50,
                    "name": "Pad See Ew",
                    "description": "Stir fried large flat rice noodles with broccoli in chef's special vegan sauce and sweet black soy sauce.",
                    "options": "(Options : Fried Tofu, Soft Tofu or Mixed Veggies)",
                },
                {
                    "price": 13.50,
                    "name": "Pad Kee Mao",
                    "description": "Stir fried large flat rice noodles with spicy Thai chili, red bell pepper, tomato, onion, green onion, broccoli and basil.",
                    "options": "(Options : Fried Tofu, Soft Tofu or Mixed Veggies)",
                },
                {
                    "price": 13.50,
                    "name": "Spicy Fried Rice",
                    "description": "Stir fried rice with fresh chili, onion, green onion, red bell pepper, broccoli, tomato and basil. (Brown rice add $2)",
                    "options": "(Options : Fried Tofu, Soft Tofu or Mixed Veggies)",
                },
            ],
        },
        {
            ...
            "section items": [
                ...
                },
                {
                    "price": 13.50,
                    "name": "Green Curry",
                    "description": "Creamy coconut milk, green bean, basil leaves and eggplant seasoned with fresh green chili, shallot, garlic, galangal, lemongrass. ",
                    "gf option": true,
                    "options": "(Options : Fried Tofu, Soft Tofu or Mixed Veggies)",
                },
                {
                    "price": 13.50,
                    "name": "Panang Curry",
                    "description": "Creamy coconut milk, eggplant, green bell pepper seasoned with dried chili pepper, coriander root and cumin.",
                    "gf option": true,
                    "options": "(Options : Fried Tofu, Soft Tofu or Mixed Veggies)",
                },
                {
        ...
        {
            "section title": "VEGAN SOUP",
            "section items": [
                {
                    "name": "Tom Yum",
                    "description": "Choice of fried tofu, soft tofu or mixed vegetables in hot and sour soup with lemon grass, lime juice, fresh chili, galangal, mushroom and tomato.",
                    "options": "Bowl&nbsp;$8 Hot Pot&nbsp;$13",
                },
                {
                    "name": "Tom Kha",
                    "description": "Choice of fried tofu, soft tofu or mixed vegetables in hot and sour soup with fresh coconut cream, lemongrass, lime juice, fresh chili, galangal, tomato and mushroom.",
                    "options": "Bowl&nbsp;$8.50 Hot Pot&nbsp;$14",
                },
            ],
        },
